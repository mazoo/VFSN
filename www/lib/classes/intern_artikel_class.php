...
class intern_artikel
{
	...
	function image_new_thumb($sessdat, $reporeid)
	{
		...
		//Wenn geändert wurde
		if($this->checked->breite > 50 or $this->checked->hohe > 50) {
			if($this->checked->breite < 500 or $this->checked->hohe < 500) {

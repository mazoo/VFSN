<?php /* Smarty version 2.6.26, created on 2021-01-10 18:08:33
         compiled from /var/www/html/styles_default/templates/index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/var/www/html/styles_default/templates/index.html', 20, false),array('modifier', 'count', '/var/www/html/styles_default/templates/index.html', 60, false),array('modifier', 'date_format', '/var/www/html/styles_default/templates/index.html', 97, false),)), $this); ?>
<!-- TEMPLATE: index.html -->
...
<?php else: ?>
        ...
        <?php if ($this->_tpl_vars['error_comment']): ?>
            <strong class="error"><?php echo $this->_tpl_vars['error_comment']; ?>
</strong>
        <?php endif; ?>
...
" name="send_artikel"/>
    ...
    <?php else: ?>                 <a id="artikel"></a><span class="ignore">.</span>
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <?php if (count($this->_tpl_vars['table_data']) > 1 || $this->_tpl_vars['bis_article'] || $this->_tpl_vars['filter_falsch'] == 'yes'): ?>
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
?>
                ...
                <?php if ($this->_foreach['artikel']['total'] <= 1): ?>
                                        <article class="floatbox artikel_details<?php if ($this->_tpl_vars['table']['reporeid']): ?> reporeid-<?php echo $this->_tpl_vars['table']['reporeid']; ?>
<?php endif; ?>">
                <?php else: ?>
                                        <article class="floatbox artikel_liste<?php if ($this->_tpl_vars['table']['reporeid']): ?> reporeid-<?php echo $this->_tpl_vars['table']['reporeid']; ?>
<?php endif; ?>">
                <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
                        ...
                        <?php if ($this->_tpl_vars['table']['uberschrift']): ?>
                                                        <?php if ($this->_foreach['artikel']['total'] <= 1): ?>
                                                                <h1><?php echo $this->_tpl_vars['table']['uberschrift']; ?>
<?php echo $this->_tpl_vars['table']['sprechomatlink']; ?>
</h1>
                            <?php else: ?>
                                                                <h2><?php echo $this->_tpl_vars['table']['uberschrift']; ?>
<?php echo $this->_tpl_vars['table']['sprechomatlink']; ?>
</h2>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <?php if ($this->_tpl_vars['menuid_aktuell'] > 1): ?>
                            <div class="date_article">
                                <?php if ($this->_tpl_vars['anzeig_autor'] == 1): ?>
                                    <i class="fa fa-user"></i><?php echo $this->_tpl_vars['message_2010']; ?>
...
<?php endif; ?>
                    ...
                    </article>             <?php endforeach; endif; unset($_from); ?>
...
" method="post">
 ...
 <out><?php echo $this->_tpl_vars['username_neu_comment']; ?>
</out></p>
										<?php else: ?>
											<p>
												...
												<br/>
												<input type="text" class="inpt" inputmode="latin-name" id="neuvorname" name="neuvorname" size="30" maxlength="78" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['author'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" required="required" />
											</p>
										<?php endif; ?>
										<p>
											...
											<input type="text" class="inpt" id="formthema" inputmode="latin" name="formthema" size="30" maxlength="78" value="<?php echo $this->_tpl_vars['message_2018']; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['formthema'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" required="required" />
										</p>
										<p>
																						<label for="inhalt"><?php echo $this->_tpl_vars['message_2021']; ?>
</label><br/>
											<textarea class="txt" id="inhalt" name="inhalt" inputmode="latin-prose" rows="10" cols="30"><?php echo ((is_array($_tmp=$this->_tpl_vars['inhalt'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
</textarea>
										</p>
																						<label for="email"><?php echo $this->_tpl_vars['message_2109']; ?>
</label><br/>
											<input type="email" class="inpt" id="email" name="email" size="30" maxlength="78" placeholder="<?php echo $this->_tpl_vars['message_2109']; ?>
